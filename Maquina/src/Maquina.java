...
public class Maquina {
    ...
    private static int N_USUARIOS = 5;
    private static Boolean serverup = Boolean.TRUE;
    static void threadlisto() {
        pool.quitar_thread();
    }
    private void startMaquina(int port)//Método para iniciar el servidor
    {
        try
        {
            pool = new ThreadPool(N_USUARIOS);
